...
#set_property PACKAGE_PIN E19 [get_ports {lightB[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {lightB[1]}]
#set_property PACKAGE_PIN U19 [get_ports {lightB[2]}]
...
#set_property PACKAGE_PIN P1 [get_ports {lightA[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {lightA[1]}]
#set_property PACKAGE_PIN L1 [get_ports {lightA[0]}]
...
set_property PACKAGE_PIN T18 [get_ports nextWord]
...
#set_property PACKAGE_PIN U17 [get_ports space]
